<template>
    <div class="background">
        ...
        <div class="team-content">
            ...
            <div v-if="myJoiningList.length === 0" class="no-teams-message">您暂无审核中的小队</div>
            <div v-else>
            ...
            <div v-if="myJoinedList.length === 0" class="no-teams-message">您暂无已加入的小队</div>
            <div v-else>
...
// 获取我已申请正在审核中的小队
axios.get('http://8.130.25.70:5555/api/Users/SelectTeam?id=843526A2B7784E73B28E73C797A2C81C&status=0')
    .then(res => {
        console.log(res.data);
        myJoiningList.value = res.data
    });
// 获取我加入的小队信息
axios.get('http://8.130.25.70:5555/api/Users/SelectTeam?id=843526A2B7784E73B28E73C797A2C81C&status=1')
    .then(res => {
        console.log(res.data);
